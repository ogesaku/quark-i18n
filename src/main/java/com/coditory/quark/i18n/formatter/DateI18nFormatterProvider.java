...
public final class DateI18nFormatterProvider implements I18nFormatterProvider {
    public static final String FILTER = "date";
    ...
    private DateFormat createFormatter(I18nMessages messages, String style) {
        return Stream.of(
                ...
                .orElseGet(() -> createSystemFormatter(messages.getLocale(), style));
    }
