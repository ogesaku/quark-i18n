...
class Json18nParserSpec extends Specification {
    @Unroll
    def "should parse JSON i18n messages"() {
        when:
            Map<I18nKey, String> parsed = I18nParsers.parseJson("""
            {
              "title": {
                "en": "Homepage",
                "pl": "Strona domowa"
    ...
    @Unroll
    def "should parse JSON i18n messages with predefined locale and prefix"() {
        when:
            Map<I18nKey, String> parsed = I18nParsers.parseJson("""
            {
              "title": "Homepage",
