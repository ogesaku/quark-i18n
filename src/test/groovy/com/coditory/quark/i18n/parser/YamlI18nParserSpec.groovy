...
class YamlI18nParserSpec extends Specification {
    @Unroll
    def "should parse YAML i18n messages"() {
        when:
            Map<I18nKey, String> parsed = I18nParsers.parseYaml("""
            title:
              en: Homepage
              pl: Strona domowa
            """.stripIndent().trim())
    ...
    @Unroll
    def "should parse YAML i18n messages with predefined locale and prefix"() {
        when:
            Map<I18nKey, String> parsed = I18nParsers.parseYaml("""
            title: Homepage
            user:
